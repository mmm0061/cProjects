/*
 ...
 Functionality: It takes a predefined text (e.g. "Scrambling is fun, is not it? (;\t") then scrambles it. The code works as follows:
...
int main(void) {
    ...
    char string[] = "Scrambling is fun, is not it? (;\t";
